...
export default async function Page() {
 ...
 return <div className="mx-auto max-w-4xl space-y-6"><h1 className="text-2xl font-bold">Tablón de actualizaciones</h1><ResourceList items={items.filter(i => i.kind === 'update')} /></div>
}
